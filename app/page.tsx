...
const SUMMARY_CARDS = [
  ...
  { key: 'v2_mgmt_review_actions', label: 'KPI 5: Actions Closed', color: '#20c997' },
...
const SMARTSHEET_LINKS: Record<string, string> = {
  v2_onsite_induction: 'https://app.smartsheet.com/sheets/3Jwp8qvPc7W878MgVRJf3c86MRH4JJ3HfjmvvmH1',
  v2_permit_to_work: 'https://app.smartsheet.com/sheets/3Jwp8qvPc7W878MgVRJf3c86MRH4JJ3HfjmvvmH1',
  v2_hazard_id: 'https://app.smartsheet.com/sheets/3HcmRx4G627MP2F5XX7F2cQx96qV2RPMmFH7Ffj1',
  v2_risk_closed: 'https://app.smartsheet.com/sheets/3HcmRx4G627MP2F5XX7F2cQx96qV2RPMmFH7Ffj1',
  v2_risk_validated: 'https://app.smartsheet.com/sheets/3HcmRx4G627MP2F5XX7F2cQx96qV2RPMmFH7Ffj1',
  v2_safe_working: 'https://app.smartsheet.com/sheets/Q2Hh5C5hXrMCW4H45Mr9R9XjRwpxP6vpQQFq6J21',
  v2_findings_on_time: 'https://app.smartsheet.com/sheets/WVWfH8vQQPpVWq6g7XvvHWRmmM93GPmvv8gR89f1',
  v2_ehs_inspection: 'https://app.smartsheet.com/sheets/WVWfH8vQQPpVWq6g7XvvHWRmmM93GPmvv8gR89f1',
  ...
  ehs_rate: 'https://app.smartsheet.com/sheets/WVWfH8vQQPpVWq6g7XvvHWRmmM93GPmvv8gR89f1',
  findings_rate: 'https://app.smartsheet.com/sheets/WVWfH8vQQPpVWq6g7XvvHWRmmM93GPmvv8gR89f1',
...
const KPI_CHARTS = [
  ...
  { key: 'v2_mgmt_review_actions', label: 'KPI 5: Committee Meeting Actions Closed', plannedLabel: 'Total Actions', actualLabel: 'Actions Closed', type: 'planned_actual' },
...
export default function Dashboard() {
  ...
  const [chartConfig, setChartConfig] = useState<{key: string, label: string, visible: boolean}[]>(() => {
    ...
    if (typeof window !== 'undefined') {
      try { const s = localStorage.getItem('hct-chart-config'); if (s) { const saved = JSON.parse(s); const sm = new Map(saved.map((c) => [c.key, c])); return defaultCfg.map(d => { const sv = sm.get(d.key); return sv ? { ...d, visible: (sv as any).visible } : d; }); } } catch {}
    }
    return defaultCfg;
  });
  ...
  const summaryValues = useMemo(() => {
    ...
    return SUMMARY_CARDS.map(card => {
      ...
      if (agg.planned === 0 && agg.actual === 0) return { ...card, display: 'N/A', sub: 'No planned data', planned: 0, actual: 0 };
      if (agg.planned > 0) {
              ...
              <label>Time Period</label>
                ...
                {pptPeriod === 'month' && (
                  <>
                    ...
                    <select value={pptMonth} onChange={e => setPptMonth(e.target.value)} style={{width:'100%',padding:'8px',marginBottom:'12px',borderRadius:'4px',border:'1px solid #ccc'}}>
