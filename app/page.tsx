...
function KpiPieChart({ rows }: { rows: KpiRow[] }) {
  ...
  const options: Highcharts.Options = {
    chart: { type: 'pie', height: 350, style: { fontFamily: "'Segoe UI', Arial, sans-serif" } },
    title: { text: undefined },
    plotOptions: { pie: { size: '90%', center: ['50%', '50%'], dataLabels: { enabled: true, format: '{point.y}', distance: -15, style: { fontSize: '11px', fontWeight: 'bold', color: 'white', textOutline: 'none' } }, showInLegend: true } },
