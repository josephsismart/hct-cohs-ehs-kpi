...
export const SYNC_SOURCES: SyncSource[] = [
  ...
  { key: 'v2_incident_types', sheetId: '5977763159691140', tab: 'raw_v2_incident_types', campusCol: 'Incident Type', valueCol: 'Total Incident', monthCol: 'Reporting Month', hasMonth: true, isolateFromCampusSet: true },
  ...
  { key: 'v2_findings_on_time', sheetId: '1510149721116548', tab: 'raw_v2_findings_on_time', campusCol: 'Campus Code', plannedCol: 'No. of Findings in Reporting Month', actualCol: 'No. of Findings Due', monthCol: 'Primary', hasMonth: true },
  ...
  { key: 'v2_onsite_induction', sheetId: '3519179394076548', tab: 'raw_v2_onsite_induction', campusCol: 'Campus Code', plannedCol: 'No. of New Contractors (Individuals)', actualCol: 'Contractors Inducted in the Reporting Month', monthCol: 'Reporting Month', hasMonth: true },
  ...
  { key: 'v2_mgmt_review_actions', sheetId: '3676598984200068', tab: 'raw_v2_mgmt_review_actions', campusCol: 'Campus Group', monthCol: 'Reporting Month', hasMonth: true, isolateFromCampusSet: true },
];
...
export const SYNC_SOURCES: SyncSource[] = [
  ...
  // V2 KPIs — matched to GAS SyncService.gs
  { key: 'v2_hs_committee', sheetId: '5093607634587524', tab: 'raw_v2_hs_committee', campusCol: 'Committee', plannedCol: 'Meeting Planned', actualCol: 'Meeting Conducted', monthCol: 'Reporting Month', hasMonth: true, isolateFromCampusSet: true },
  { key: 'v2_findings_on_time', sheetId: '1510149721116548', tab: 'raw_v2_findings_on_time', campusCol: 'Campus Code', plannedCol: 'No. of Findings in Reporting Month', actualCol: 'No. of Findings Due', monthCol: 'Primary', hasMonth: true },
  { key: 'v2_risk_closed', sheetId: '7524088825204612', tab: 'raw_v2_risk_closed', campusCol: 'Campus Code', plannedCol: 'Total Risk Assessments Registered', actualCol: 'Risk Assessment Closed', monthCol: 'Primary', hasMonth: true },
  { key: 'v2_risk_validated', sheetId: '7524088825204612', tab: 'raw_v2_risk_validated', campusCol: 'Campus Code', plannedCol: 'Total Assessments Register', actualCol: 'RA Validated and Signed Off', monthCol: 'Primary', hasMonth: true },
  { key: 'v2_ehs_inspection', sheetId: '1510149721116548', tab: 'raw_v2_ehs_inspection', campusCol: 'Campus Code', plannedCol: 'No. of EHS Inspections Planned', actualCol: 'No. of EHS Inspections Completed', monthCol: 'Primary', hasMonth: true },
  // { key: 'v2_hs_kpi_report', reportId: '4811266391494532', tab: 'raw_v2_hs_kpi_report', campusCol: 'Campuses', valueCol: 'Submitted', monthCol: 'Primary', hasMonth: true }, // Disabled: report 404
  { key: 'v2_external_compliance', sheetId: '1325212455882628', tab: 'raw_v2_external_compliance', campusCol: 'Campus Code', plannedCol: 'Applicable Compliance', actualCol: 'Actual Compliance', monthCol: 'Primary', hasMonth: true },
  { key: 'v2_safe_working', sheetId: '2717764266446724', tab: 'raw_v2_safe_working', campusCol: 'Campus Code', plannedCol: 'No. of SOPs Verified', actualCol: 'No. of SOPs Implemented', monthCol: 'Primary', hasMonth: true },
